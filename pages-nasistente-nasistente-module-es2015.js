...
let NasistentePageModule = class NasistentePageModule {
};
...
let NasistentePage = class NasistentePage {
    constructor(storage, asistenteService, navCtrl, uiService) {
    ...
    nuevoAsistente(fAsistente) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const valido = yield this.asistenteService.createAsistente(this.asistente);
            if (valido) {
    ...
    getCodigo() {
        this.asistenteService.getCodigo().subscribe(response => {
            this.asistente.codigo = response['code'];
        });
    }
};
NasistentePage.ctorParameters = () => [
...
//# sourceMappingURL=pages-nasistente-nasistente-module-es2015.js.map