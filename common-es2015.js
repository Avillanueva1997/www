...
let AsistenteService = class AsistenteService {
    ...
    createAsistente(asistente) {
        ...
        return new Promise(resolve => {
            this.http.post(`${URL}/asistente`, asistente, { headers }).subscribe(response => {
                if (response['ok']) {
    ...
    uploadFile(files, postid) {
        ...
        if (fileCount > 0) {
            ...
            return new Promise(resolve => {
                this.http.post(`${URL}/asistente/upload/${postid}`, formData, { headers }).subscribe(response => {
                    if (response['ok']) {
    ...
    updateAsistente(params) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(resolve => {
            this.http.post(`${URL}/asistente/updateasistencia`, params, { headers }).subscribe(response => {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    updateAsistenteComplete(asistente) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(resolve => {
            this.http.post(`${URL}/asistente/update`, asistente, { headers }).subscribe(response => {
                if (response['ok']) {
                    resolve(true);
                }
                else {
...
AsistenteService.ctorParameters = () => [
...
let PostsService = class PostsService {
    constructor(http, userService, fileTransfer) {
        this.http = http;
        this.userService = userService;
...
let SalaService = class SalaService {
    ...
    createSala(sala) {
        ...
        return new Promise(resolve => {
            this.http.post(`${URL}/sala`, sala, { headers }).subscribe(response => {
                if (response['ok']) {
    ...
    updateSalaComplete(sala) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(resolve => {
            this.http.post(`${URL}/sala/update`, sala, { headers }).subscribe(response => {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    createSalaAsistente(sala, asistente, post) {
        const parametros = {
            sala,
            asistente,
            post
        ...
        return new Promise(resolve => {
            this.http.post(`${URL}/sala/savesa`, parametros, { headers }).subscribe(response => {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    getSalaAsistentes(post, sala) {
        return this.http.get(`${URL}/sala/tablesa/${post}/${sala}`);
    }
};
SalaService.ctorParameters = () => [
