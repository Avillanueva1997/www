...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(postService, router, geolocation, camera, platform, uiService, el) {
    ...
    Tab2Page.prototype.crearPost = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postService.createPost(this.post)];
                    case 1:
                        creado = _a.sent();
                        this.post = {
                            mensaje: '',
    ...
    Tab2Page.prototype.procesarImagen = function (options) {
        ...
        this.camera.getPicture(options).then(function (imageData) {
            ...
            _this.postService.subirImagen(imageData);
            _this.tempImages.push(img);
        }, function (err) {
            // Handle error
        });
    };
    Tab2Page.prototype.getFile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var inputEl, files;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
...
var DomSanitizerPipe = /** @class */ (function () {
    ...
    DomSanitizerPipe.ctorParameters = function () { return [
...
var ImageSanitizerPipe = /** @class */ (function () {
    ...
    ImageSanitizerPipe.ctorParameters = function () { return [
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }
    ]; };
