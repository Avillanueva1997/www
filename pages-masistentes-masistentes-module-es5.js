...
var MasistentesPageModule = /** @class */ (function () {
    function MasistentesPageModule() {
    }
...
var MasistentesPage = /** @class */ (function () {
    function MasistentesPage(el, asistenteService, storage, uiService) {
        this.el = el;
    ...
    MasistentesPage.prototype.ngOnInit = function () {
        this.cargarPost();
    };
    MasistentesPage.prototype.getFile = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var inputEl, files, response;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        inputEl = this.el.nativeElement.querySelector('#file');
                        files = inputEl.files;
                        return [4 /*yield*/, this.asistenteService.uploadFile(files, this.post)];
                    case 1:
                        response = _a.sent();
                        if (response === false) {
    ...
    MasistentesPage.prototype.cargarPost = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
    ...
    MasistentesPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-masistentes-masistentes-module-es5.js.map