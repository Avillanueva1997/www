...
var VsalaPageModule = /** @class */ (function () {
    function VsalaPageModule() {
    }
...
var VsalaPage = /** @class */ (function () {
    function VsalaPage(salaService, storage) {
    ...
    VsalaPage.prototype.ionViewWillEnter = function () {
        this.cargarPost();
        this.cargarSala();
    };
    VsalaPage.prototype.cargarPost = function () {
    ...
    VsalaPage.prototype.cargarSala = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
    ...
    VsalaPage.prototype.getDataSalaAsistente = function () {
        var _this = this;
        this.salaService.getSalaAsistentes(this.post, this.sala).subscribe(function (response) {
            _this.asistentes = response['asistentes'];
            console.log(_this.asistentes);
            var tempData = [];
            for (var _i = 0, _a = _this.asistentes; _i < _a.length; _i++) {
                var item = _a[_i];
                var data = {
            ...
            _this.dataGlobal = tempData;
            console.log(_this.dataGlobal);
        });
    };
    VsalaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-vsala-vsala-module-es5.js.map