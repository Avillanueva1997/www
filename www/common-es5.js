...
/***/ "./src/app/services/asistente.service.ts":
/*!***********************************************!*\
  !*** ./src/app/services/asistente.service.ts ***!
  \***********************************************/
/*! exports provided: AsistenteService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AsistenteService", function() { return AsistenteService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var AsistenteService = /** @class */ (function () {
    function AsistenteService(http, userService) {
        this.http = http;
        this.userService = userService;
        this.nuevoAsistente = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    AsistenteService.prototype.createAsistente = function (asistente) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(function (resolve) {
            _this.http.post(URL + "/asistente", asistente, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    _this.nuevoAsistente.emit(response['asistente']);
                    resolve(true);
                }
                else {
                    resolve(false);
    ...
    AsistenteService.prototype.getAsistentes = function (postid) {
        return this.http.get(URL + "/asistente/?postid=" + postid);
    };
    AsistenteService.prototype.getAsistentesBySearch = function (postid, value) {
        return this.http.get(URL + "/asistente/search/" + postid + "/" + value);
    };
    AsistenteService.prototype.evaluateCodeQr = function (postid, codigo) {
        return this.http.get(URL + "/asistente/evaluate/" + postid + "/" + codigo);
    };
    AsistenteService.prototype.uploadFile = function (files, postid) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        ...
        if (fileCount > 0) {
            ...
            return new Promise(function (resolve) {
                _this.http.post(URL + "/asistente/upload/" + postid, formData, { headers: headers }).subscribe(function (response) {
                    if (response['ok']) {
    ...
    AsistenteService.prototype.updateAsistente = function (params) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(function (resolve) {
            _this.http.post(URL + "/asistente/updateasistencia", params, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    AsistenteService.prototype.updateAsistenteComplete = function (asistente) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(function (resolve) {
            _this.http.post(URL + "/asistente/update", asistente, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    AsistenteService.prototype.getIndicadoresOne = function (postid) {
        return this.http.get(URL + "/asistente/indicadorOne/" + postid);
    };
    AsistenteService.prototype.getIndicadoresTwo = function (postid) {
        return this.http.get(URL + "/asistente/indicadorTwo/" + postid);
    };
    AsistenteService.prototype.getIndicadoresThree = function (postid) {
        return this.http.get(URL + "/asistente/indicadorThree/" + postid);
    };
    AsistenteService.prototype.getCodigo = function () {
        return this.http.get(URL + "/asistente/codigo");
    };
    AsistenteService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
        { type: _usuario_service__WEBPACK_IMPORTED_MODULE_3__["UsuarioService"] }
    ]; };
    AsistenteService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var PostsService = /** @class */ (function () {
    function PostsService(http, userService, fileTransfer) {
        this.http = http;
        this.userService = userService;
        this.fileTransfer = fileTransfer;
        this.paginaPosts = 0;
        this.nuevoPost = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    ...
    PostsService.prototype.createPost = function (post) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(URL + "/posts", post, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    _this.nuevoPost.emit(response['post']);
                    resolve(true);
                }
            });
        });
    };
    PostsService.prototype.subirImagen = function (img) {
        var options = {
            fileKey: 'image',
            headers: {
                'x-token': this.userService.token
    ...
    PostsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _usuario_service__WEBPACK_IMPORTED_MODULE_4__["UsuarioService"], _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_5__["FileTransfer"]])
    ], PostsService);
    return PostsService;
}());
...
var SalaService = /** @class */ (function () {
    function SalaService(userService, http) {
        this.userService = userService;
        this.http = http;
        this.nuevaSala = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    SalaService.prototype.createSala = function (sala) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(function (resolve) {
            _this.http.post(URL + "/sala", sala, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    _this.nuevaSala.emit(response['sala']);
                    resolve(true);
                }
                else {
                    resolve(false);
    ...
    SalaService.prototype.getSalas = function (postid) {
        return this.http.get(URL + "/sala/?postid=" + postid);
    };
    SalaService.prototype.updateSalaComplete = function (sala) {
        var _this = this;
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]({
            'x-token': this.userService.token
        });
        return new Promise(function (resolve) {
            _this.http.post(URL + "/sala/update", sala, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    SalaService.prototype.deleteSala = function (codigo) {
        return this.http.get(URL + "/sala/delete/" + codigo);
    };
    SalaService.prototype.createSalaAsistente = function (sala, asistente, post) {
        var _this = this;
        var parametros = {
            sala: sala,
            asistente: asistente,
        ...
        return new Promise(function (resolve) {
            _this.http.post(URL + "/sala/savesa", parametros, { headers: headers }).subscribe(function (response) {
                if (response['ok']) {
                    resolve(true);
                }
                else {
    ...
    SalaService.prototype.getSalaAsistentes = function (post, sala) {
        return this.http.get(URL + "/sala/tablesa/" + post + "/" + sala);
    };
    SalaService.ctorParameters = function () { return [
        { type: _usuario_service__WEBPACK_IMPORTED_MODULE_2__["UsuarioService"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
    SalaService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
