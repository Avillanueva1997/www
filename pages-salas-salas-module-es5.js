...
var ModalEditSalaPageModule = /** @class */ (function () {
    function ModalEditSalaPageModule() {
    }
    ...
    return ModalEditSalaPageModule;
}());
...
var ModalEditSalaPage = /** @class */ (function () {
    function ModalEditSalaPage(modalCtrl, toastController, salaService, uiService) {
        this.modalCtrl = modalCtrl;
        this.toastController = toastController;
        this.salaService = salaService;
        this.uiService = uiService;
    }
    ModalEditSalaPage.prototype.ngOnInit = function () {
        console.log(this.sala);
    };
    ModalEditSalaPage.prototype.salirConArgumentos = function () {
        this.modalCtrl.dismiss({
            ok: true,
        });
    };
    ModalEditSalaPage.prototype.presentToast = function () {
    ...
    ModalEditSalaPage.prototype.updateSala = function (fSala) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var name, valido;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = (this.sala.name) ? this.sala.name : '';
                        this.sala.name = this.capitalize(name);
                        if (fSala.invalid) {
                            return [2 /*return*/];
                        }
                        return [4 /*yield*/, this.salaService.updateSalaComplete(this.sala)];
                    case 1:
                        valido = _a.sent();
                        if (valido) {
                            this.presentToast();
    ...
    ModalEditSalaPage.prototype.capitalize = function (value) {
        return value.replace(/(?:^|\s)\S/g, function (l) { return l.toUpperCase(); });
    };
    ModalEditSalaPage.ctorParameters = function () { return [
...
var SalasPage = /** @class */ (function () {
    function SalasPage(storage, salaService, modalCtrl, navCtrl) {
    ...
    SalasPage.prototype.onEdit = function (sala) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var modal, data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    SalasPage.prototype.onDelete = function (sala) {
        var _this = this;
        var codigo = sala.codigo;
        this.salaService.deleteSala(codigo).subscribe(function (response) {
            if (response['ok']) {
                _this.salas = response['salas'];
                _this.recargar(sala.post);
            }
        });
    };
    SalasPage.prototype.onWatch = function (sala) {
