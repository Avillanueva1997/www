...
var map = {
	"./pages/asistentes/asistentes.module": [
		"./src/app/pages/asistentes/asistentes.module.ts",
		"default~pages-asistentes-asistentes-module~pages-vasistente-vasistente-module",
		"common",
		"pages-asistentes-asistentes-module"
	],
	"./pages/general-data/general-data.module": [
	...
	"./pages/login/login.module": [
		...
		"default~pages-login-login-module~tab1-tab1-module~tab3-tab3-module",
		"pages-login-login-module"
	],
	"./pages/masistentes/masistentes.module": [
		"./src/app/pages/masistentes/masistentes.module.ts",
		"common",
		"pages-masistentes-masistentes-module"
	],
	"./pages/nasistente/nasistente.module": [
		"./src/app/pages/nasistente/nasistente.module.ts",
		"common",
		"pages-nasistente-nasistente-module"
	],
	"./pages/nsala/nsala.module": [
	...
	"./pages/scancodigo/scancodigo.module": [
		"./src/app/pages/scancodigo/scancodigo.module.ts",
		"common",
		"pages-scancodigo-scancodigo-module"
	],
	"./pages/scansala/scansala.module": [
	...
	"./pages/vasistente/vasistente.module": [
		"./src/app/pages/vasistente/vasistente.module.ts",
		"default~pages-asistentes-asistentes-module~pages-vasistente-vasistente-module",
		"pages-vasistente-vasistente-module"
	],
	"./pages/vsala/vsala.module": [
...
/* harmony import */ var _guards_usuario_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./guards/usuario.guard */ "./src/app/guards/usuario.guard.ts");
...
var routes = [
    {
        path: 'main',
        loadChildren: function () { return __webpack_require__.e(/*! import() | pages-tabs-tabs-module */ "pages-tabs-tabs-module").then(__webpack_require__.bind(null, /*! ./pages/tabs/tabs.module */ "./src/app/pages/tabs/tabs.module.ts")).then(function (m) { return m.TabsPageModule; }); },
...
/* harmony import */ var ngx_qrcode2__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ngx-qrcode2 */ "./node_modules/ngx-qrcode2/index.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                ngx_qrcode2__WEBPACK_IMPORTED_MODULE_15__["NgxQRCodeModule"],
...
var UsuarioGuard = /** @class */ (function () {
    ...
    UsuarioGuard.ctorParameters = function () { return [
...
var UsuarioService = /** @class */ (function () {
    ...
    UsuarioService.prototype.login = function (email, password) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(URL + "/user/login", data).subscribe(function (response) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!response['ok']) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.guardarToken(response['token'])];
                        case 1:
                            _a.sent();
                            resolve(true);
                            return [3 /*break*/, 3];
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, new Promise(function (resolve) {
                                ...
                                _this.http.get(URL + "/user/", { headers: headers }).subscribe(function (response) {
                                    if (response['ok']) {
    ...
    UsuarioService.prototype.actualizarUsuario = function (usuario) {
        ...
        return new Promise(function (resolve) {
            _this.http.post(URL + "/user/update", usuario, { headers: headers }).
                ...
                if (response['ok']) {
                    _this.guardarToken(response['token']);
                    resolve(true);
                }
                else {
                    resolve(false);
    ...
    UsuarioService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["NavController"]])
    ], UsuarioService);
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\proyectoFinalCPG\cpg\src\main.ts */"./src/main.ts");
