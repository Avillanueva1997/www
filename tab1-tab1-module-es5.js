...
var Tab1Page = /** @class */ (function () {
    function Tab1Page(postService, storage) {
    ...
    Tab1Page.prototype.ngOnInit = function () {
        var _this = this;
        this.siguientes();
        this.postService.nuevoPost.subscribe(function (post) {
    ...
    Tab1Page.prototype.siguientes = function (event, pull) {
        ...
        this.postService.getPosts(pull).subscribe(function (response) {
            var _a;
            (_a = _this.posts).push.apply(_a, response.posts);
            if (event) {
