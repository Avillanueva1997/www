...
let GeneralDataPageModule = class GeneralDataPageModule {
};
...
let GeneralDataPage = class GeneralDataPage {
    constructor(eventService, navCtrl, uiService, storage) {
    ...
    dataEvent(fEvent) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            const valido = yield this.eventService.createEvent(this.event);
            if (valido) {
...
GeneralDataPage.ctorParameters = () => [
...
let EventService = class EventService {
    ...
    createEvent(event) {
        ...
        return new Promise(resolve => {
            this.http.post(`${URL}/event`, event, { headers }).subscribe(response => {
                if (response['ok']) {
...
//# sourceMappingURL=pages-general-data-general-data-module-es2015.js.map